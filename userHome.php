...
<body>
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full" id="menu">
            <nav>
                <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                    ...
                    <button><a class="p-2 px-6 bg-teal-500 text-white rounded-md hover:bg-teal-600 mx-4" href="closesession.php">Logout</a></button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-5">
        ...
        while ($libros = $sql->fetch_object()) { ?>
            ...
            <div class="  w-[70%] md:w-[100%]  mx-2 my-10 p-5 py-12 text-left transform duration-500 hover:-translate-y-2 shadow-2xl cursor-pointer relative">
                ...
                <button class="p-2 px-6 bg-teal-500 text-white rounded-md hover:bg-teal-600">
                <a href="singleProduct.php?id=<?= $libros->id ?>">Ver producto</a>
                </button>
